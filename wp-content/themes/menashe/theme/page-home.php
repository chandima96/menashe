...
<div class="lg:hidden block w-full">
    <div class="grid grid-cols-2 w-full gap-3">
        <div>
            <button class="flex justify-center items-center border-2 border-black bg-[#2ed02e] w-full text-white p-5 m-3">
        ...
        <div>
            <button class="flex justify-center items-center border-2 border-black bg-submit w-full text-black p-5 m-3">
