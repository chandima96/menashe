            ...
            <div class="flex flex-col justify-center">
                <div class="grid gap-3">
                    <div class="flex justify-center w-full">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" class="h-[15.16%] w-[15.22%] flex justify-center" alt="">
                    </div>
                    ...
                    <div class="text-center mx-3">
                        <div class="bg-submit h-16 w-full flex items-center justify-center">
                            <p class="text-white font-extrabold text-3xl md:text-[43px] leading-[35.25px] Heebo"><?php echo get_field('gold_box_text'); ?></p>
