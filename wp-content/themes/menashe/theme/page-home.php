    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 m-3 lg:mt-6 lg:ml-6 lg:mr-6">
        <div class="col-span-1 order-2 lg:order-1 pr-0 lg:pr-7">
            <div class="flex flex-col  justify-center">
                ...
                <h1 class="text-center font-bold md:text-5xl font-heebo"><?php echo get_field('home_title'); ?></h1>

                <div class="text-center mx-3 mt-6">
                    <div class="bg-submit h-20 w-full flex items-center justify-center">
                        <p class="text-white font-extrabold text-3xl md:text-5xl leading-[48px] font-heebo"><?php echo get_field('gold_box_text'); ?></p>
                        <img src="<?php echo get_template_directory_uri(); ?>/images/1585.png" class="" alt="">
                    </div>
                    <div class="bg-black text-white h-8 w-full font-bold md:text-2xl">
                        <?php echo get_field('black_box_text'); ?>
                    </div>
                </div>
                <div class="text-[#c8a950] w-full text-center flex justify-center mt-6">
                    <p class="font-bold md:text-3xl mt-auto font-heebo"><?php echo get_field('gold_text_one'); ?></p>
                    <p class="font-bold md:text-6xl font-heebo"><?php echo get_field('gold_text_two'); ?> </p>
    ...
    <div class="grid grid-cols-2 gap-3 m-3">
        <div>
            <button class="flex justify-center items-center border-2 border-black bg-[#2ed02e] w-full text-white p-5">
                ...
                <div class="md:text-4xl font-karantina pl-3">לשיחה עם נציג</div>
            </button>
        </div>
        <div>
            <button class="flex justify-center items-center border-2 border-black bg-submit w-full text-black p-5">
                ...
                <div class="md:text-4xl font-karantina pl-3">לפרטים נוספים</div>
            </button>
        </div>
    </div>
